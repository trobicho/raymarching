...
/*   Updated: 2019/05/13 14:27:10 by trobicho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	key_cam(t_mymlx *ml, int keycode)
{
	if (keycode == 126)
		...
		cam_rotate(&ml->cam, -3.14 / 45, ml->cam.up);
	else if (keycode == 88)
		cam_rotate(&ml->cam, 3.14 / 45, ml->cam.up);
	else if (keycode == 84)
		cam_rotate(&ml->cam, 3.14 / 45, ml->cam.right);
	else if (keycode == 91)
		cam_rotate(&ml->cam, -3.14 / 45, ml->cam.right);
	else if (keycode == 89)
		cam_rotate(&ml->cam, 3.14 / 45, ml->cam.dir);
	else if (keycode == 92)
		cam_rotate(&ml->cam, -3.14 / 45, ml->cam.dir);
	else
		return (0);
